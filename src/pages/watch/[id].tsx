...
export const getFilm=async(id:any)=>{
    const response=await axios.get<FilmID[]>(`http://188.120.248.77:80/films/${id}`)
            ...
            <section className={style.wrapper}>
                ...
                <div className={style.conteiner}>
                    ...
                    <div className={style.conteiner_info}>
                        ...
                        <h4 className={style.conteiner_info_subtitle}> {film.year} {film.time} {film.age} </h4>
                        ...
                        <div className={style.conteiner_info_persons}>
                            <div className={style.conteiner_info_persons_img}>
                                ...
                                <div key={actor.id} className={style.conteiner_info_persons_img}>
                                <Image
                        ...
                        <div className={style.conteiner_info_details}>
                            <ExpandBlock visibleBlock={film.description} width={'450px'} lineClamp={5} expandWord={'Детали о фильме'}>
                                <WatchBlock />
                            </ExpandBlock>
                        </div>
                ...
                <div className={style.wrapper_reviews}>
                    <div className={style.reviews_info}>
                        <div className={style.reviews_info_title}>
                            Отзывы
                            <span className={style.reviews_info_quantity}>383</span><p>
                        ...
                        <button className={style.reviews_info_button}>
                            <span className={style.reviews_info_button_text}>Оставить отзыв</span>
                        </button>
                    </div>
