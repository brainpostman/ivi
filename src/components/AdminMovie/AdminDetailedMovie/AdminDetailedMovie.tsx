...
const AdminDetailedMovie = ({
  ...
  return (
    <fieldset
      className={`${parentStyles.wrapper} ${propsClassName} ${styles.wrapper}`}
    >
      ...
      <div className={parentStyles.info}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_2}`}
        >
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_3}`}
        >
          <p className={parentStyles.info__item}>
            {t('score')}:{' '}
            <span className={parentStyles.info__item__value}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_4}`}
        >
          <p className={parentStyles.info__item}>
            {t('fees-ru')}:{' '}
            <span className={parentStyles.info__item__value}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_5}`}
        >
          <p className={parentStyles.info__item}>
            {t('age')}:{' '}
            <span className={parentStyles.info__item__value}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_6}`}
        >
          <p className={parentStyles.info__item}>
            {t('tagline')}:{' '}
            <span className={parentStyles.info__item__value}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_7}`}
        >
          <p className={parentStyles.info__item}>
            {t('actors')}:{' '}
            <span className={parentStyles.info__item__value}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_8}`}
        >
          <p className={parentStyles.info__item}>
            {t('directors')}:{' '}
            <span className={parentStyles.info__item__value}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_9}`}
        >
          <p className={parentStyles.info__item}>
            {t('description')}:{' '}
            <span className={parentStyles.info__item__value}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_10}`}
        >
          <p className={parentStyles.info__item}>
            {t('writers')}:{' '}
            <span className={parentStyles.info__item__value}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_11}`}
        >
          <p className={parentStyles.info__item}>
            {t('editors')}:{' '}
            <span className={parentStyles.info__item__value}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_12}`}
        >
          <p className={parentStyles.info__item}>
            {t('artists')}:{' '}
            <span className={parentStyles.info__item__value}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_13}`}
        >
          <p className={parentStyles.info__item}>
            {t('operators')}:{' '}
            <span className={parentStyles.info__item__value}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_14}`}
        >
          <p className={parentStyles.info__item}>
            {t('composers')}:{' '}
            <span className={parentStyles.info__item__value}>
        ...
        <div
          className={`${parentStyles.info__row} ${parentStyles.info__row_15}`}
        >
          <p className={parentStyles.info__item}>
            {t('spectators')}:
            <span className={parentStyles.info__item__value}>
