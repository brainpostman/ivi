...
import { IQuerySuggest } from '@/types/api/staffs.api.interface';
import { IFilterGetResponse } from '@/types/api/filters.api.interface';
import { useDebounce } from '@/hooks/useDebounce';
import { reverseFormatStaffType } from '@/formatters/staffType.format';
...
const FilterSuggest: FC<IProps> = ({
    ...
    const setterSuggestList = async () => {
        const staffs = await staffsAPI.getStaffByParams({
            search: value,
            type: reverseFormatStaffType(query),
        });
