...
const FilterTab: FC<IProps> = ({ selectFilter, filter, paramValue, children }) => {
    const titleClassName = `${style.title} ${filter?.isExpand ? style.title__active : ''}`;

    const arrowClassName = `${style.arrow} ${filter?.isExpand ? style.arrow__active : ''}`;
