...
import { Meta, ReactRenderer, StoryContext } from '@storybook/react'
...
const meta: Meta = {
  title: 'UI/Carousels/MovieCarousel',
  parameters: {
    docs: {
      description: {
...
export const Primary = (
  { films: filmsIncoming, ...props }: IProps,
  context: StoryContext<ReactRenderer>
) => {
  const { locale } = context.globals
  const films = transformFilms(filmsIncoming, locale)
  return (
    <div
      style={{
        backgroundColor: '#000',
